...
},{"./AnimatedTexture":1,"./ObjectFactory":16}],4:[function(require,module,exports){
...
},{"./AnimatedTexture":1,"./Missile":15,"./ObjectFactory":16,"./Utils":26}],8:[function(require,module,exports){
module.exports = {
	enemies: {
...
},{"./Billboard":3,"./ItemFactory":11,"./ObjectFactory":16}],11:[function(require,module,exports){
module.exports = {
	items: {
		// Items
...
},{"./Door":5,"./Enemy":7,"./EnemyFactory":8,"./Item":10,"./ItemFactory":11,"./ObjectFactory":16,"./Player":17,"./Stairs":21}],13:[function(require,module,exports){
...
},{"./MapAssembler":12,"./ObjectFactory":16,"./Utils":26}],14:[function(require,module,exports){
module.exports = {
...
},{"./ObjectFactory":16,"./Utils":26}],16:[function(require,module,exports){
var Utils = require('./Utils');
...
},{"./Missile":15,"./Utils":26}],18:[function(require,module,exports){
...
},{"./Storage":22}],20:[function(require,module,exports){
...
},{"./ObjectFactory":16}],22:[function(require,module,exports){
function Storage(){
	 try {
...
},{"./SelectClass":20}],24:[function(require,module,exports){
...
Underworld.prototype.create3DObjects = function(){
	this.door = ObjectFactory.door(vec3(0.5,0.75,0.1), vec2(1.0,1.0), this.GL.ctx);
	this.doorW = ObjectFactory.doorWall(vec3(1.0,1.0,1.0), vec2(1.0,1.0), this.GL.ctx);
	this.doorC = ObjectFactory.cube(vec3(1.0,1.0,0.1), vec2(1.0,1.0), this.GL.ctx);
...
},{"./AnimatedTexture":1,"./Audio":2,"./Console":4,"./EndingScreen":6,"./Inventory":9,"./Item":10,"./ItemFactory":11,"./MapManager":13,"./Missile":15,"./ObjectFactory":16,"./PlayerStats":18,"./SaveManager":19,"./TitleScreen":23,"./UI":24,"./Utils":26,"./WebGL":27}],26:[function(require,module,exports){
module.exports = {
